...
```
mongodb://sa-zm-los-bch:27017,sa-zm-los-bch:27018,sa-zm-los-bch:27019/dbname?replicaSet=rs
```
*where* `sa-zm-los-bch` is the *hostname* or the *name of your computer* and `dbname` is the name of your *database*.
